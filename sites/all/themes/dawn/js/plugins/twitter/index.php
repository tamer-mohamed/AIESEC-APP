...
class ezTweet {
	...
	private function getTwitterJSON() {
		...
		$tmhOAuth = new tmhOAuth(array(
			...
			'consumer_key'          => theme_get_setting('twitter-consumer-key'),
			'consumer_secret'       => theme_get_setting('twitter-consumer-secret'),
			'user_token'            => theme_get_setting('twitter-access-token'),
			'user_secret'           => theme_get_setting('twitter-access-secret'),
